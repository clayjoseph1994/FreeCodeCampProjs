...
/*
Code highlighting courtesy of https://highlightjs.org/usage/
*/
...
[X] 2. Within the #main-doc ( <main> ) element, I can see several <section> elements, each with a class of "main-section". There should be a minimum of 5. ‣
...
#Layout
[X] 1. On regular sized devices (laptops, desktops), the element with id="navbar" should be shown on the left side of the screen and should always be visible to the user. ‣
[X] 2. My Technical Documentation page should use at least one media query.
*/
